...
const urlStruct = {
  GET: {
    ...
    '/clientFinal.html': htmlHandler.getIndex,
    '/loginFinal.html': htmlHandler.getLogin,
    '/profileFinal.html': htmlHandler.getProfile,
    ...
    '/searchCharacter': jsonHandler.searchCharacter,
